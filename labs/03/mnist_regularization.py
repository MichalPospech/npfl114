...
rg = None if args.l2 == 0 else tf.keras.regularizers.L1L2(l2=args.l2)
...
for dataset_type in ["train", "dev", "test"]:
    getattr(mnist, dataset_type).data["labels"] = tf.keras.utils.to_categorical(
        getattr(mnist, dataset_type).data["labels"])
