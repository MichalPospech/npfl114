...
class Caltech42:
    ...
    class Dataset:
        ...
        def batches(self, size=None):
            ...
            idg = ImageDataGenerator(rotation_range=60, width_shift_range=30, height_shift_range=30,
                                     zoom_range=0.2, brightness_range=(0.95, 1.05), shear_range=0.01, horizontal_flip=True, vertical_flip=True)
